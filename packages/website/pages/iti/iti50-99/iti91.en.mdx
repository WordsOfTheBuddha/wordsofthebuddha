...
By performing harmful (injurious, destructive, bad, evil [pāpaka]) actions,
the evil-doer re-arises (is reborn [upapajjati]) in hell.

Better to swallow a red-hot iron ball,
burning like a blazing flame;
Than for an unprincipled (without regard for ethical conduct, immoral [dussīla]) and unrestrained (uncontrolled [asaññata]) person,
