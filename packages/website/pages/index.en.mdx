...
import Index from "/pages/books/index.mdx";
...
- [x] Translation aims to preserve causality sequence of how things come to be be, how they change and how they fade away, e.g. wearing away of the taints instead of destruction of the taints.
