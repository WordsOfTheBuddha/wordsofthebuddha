...
'What is the gratification (satisfaction, pleasure, enjoyment, sweetness [assāda]), what is the drawback (disadvantage, unsatisfactoriness, inadequacy [ādīnava]), and what is the escape (way out, remedy [nissaraṇa]) in the case of the \{earth element} (whatever internal or external, belonging to oneself, that is solid, hard, resistant, stable, supporting, and clung to [pathavīdhātu])?
What is the gratification, what is the drawback, and what is the escape in the case of the \{water element} (whatever internal or external, belonging to oneself, that is liquid, cohesive, flowing, binding, moist, and clung to [āpodhātu])?
What is the gratification, what is the drawback, and what is the escape in the case of the \{fire element} (whatever internal or external, belonging to oneself, that is heat, fiery, transformative, warming, cooling, and clung to [tejodhātu])?
What is the gratification, what is the drawback, and what is the escape in the case of the \{air element} (whatever internal or external, belonging to oneself, that is air, gaseous, moving, vibrating, wind-like, and clung to [vāyodhātu])?'

Then, bhikkhus, it occurred to me:

'Whatever ease (contentment, happiness, pleasant abiding [sukha]) and pleasure (gladness, joy, positive state of mind [somanassa]) arise dependent on the earth element is the gratification in the earth element; whatever in the earth element is impermanent (unstable, transient, unreliable [anicca]), suffering (mild suffering, intense suffering, discomfort, pain, disease, unpleasantness, stress, discontentment, dissatisfaction [dukkha]), and subject to change, that is the drawback in the earth element; the dispelling and abandoning of interest (desire, wish, intention, impulse [chanda]) and passion (desire, infatuation, lust [rāga]) for the earth element, this is the escape from the earth element.
