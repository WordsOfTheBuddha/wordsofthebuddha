...
When this was said, bhikkhus, Uddaka Rāmaputta made known the \{attainment of the base of neither perception nor non-perception} (a meditative absorption where one's awareness is so subtle that perception is barely present; it cannot be clearly defined as perception or as its absence [nevasaññānāsaññāyatana]).
...
Wisdom (insight, knowing [ñāṇa]) and vision (realization [dassana]) arose in me: 'My liberation is unshakeable, this is my last birth, now there is no more \{renewed existence} (renewal of being, reappearance, rebirth, future life [punabbhava]).'
