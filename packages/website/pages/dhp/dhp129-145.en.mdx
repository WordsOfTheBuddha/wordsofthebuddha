...
the \{immature person} (lacking in good sense or judgement, child-like in understanding [bāla]) does not understand (comprehend, realize, grasp [bujjhati]);
...
By faith (confidence, conviction, trust [saddha]), by \{ethical conduct} (virtue, moral integrity [sīla]) and with energy (persistence, willpower, determination [vīriya]),
