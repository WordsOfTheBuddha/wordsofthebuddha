...
description: DhammaPada verses 21 - 32 cover the topic of diligence and the importance of being diligent and wise. The wise one is encouraged to guard against negligence and to cultivate diligence as a path to liberation.
...
The unsurpassed (incomparable [anuttara]) safety from the bonds (yoke, attachment, which binds one to the cyclical existence [yoga]).
...
The fame (reputation, renown, prestige [yasa]) of such a diligent one surpasses.
...
Immature (childish [bāla]), unwise (undiscerning [dummedhī]) persons,
