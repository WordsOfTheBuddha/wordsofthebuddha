...
fetter: ignorance,doubt,adherence to rites and rituals,ill-will,sensual desire,conceit
id: dhp1-20
---
...
Hostility (hatred, ill-will, animosity [vera]) is never settled (calmed, appeased [sammati]) by hostility,
...
indolent (lazy, inactive person [kusīta]) and \{low in energy} (lacking in endurance [hīnavīriya]);
Māra (death personified [māra]) overpowers that one,
...
with faith (confidence, conviction [saddha]) and \{aroused energy} (with initiative [āraddhavīriya]);
...
penetrated by passion (desire, infatuation, lust [rāga]).
...
Here (s)he sorrows (grieves [socati]), after death he sorrows,
...
He is pleased, he is delighted (very happy, jubiliant [pamodati]),
...
Abandoning passion, aversion (ill-will, hate, hatred, fault, resentment [dosa]), and delusion (illusion, hallucination, misperception, distorted view; that which fuels not knowing of things as they have come to be [moha]),
