...
"Bhikkhus, there are two causes for the arising of \{right view} (view that is in line with the Dhamma [sammādiṭṭhi]). What are the two? The utterance of another and careful attention. These, bhikkhus, are the two causes for the arising of right view."
