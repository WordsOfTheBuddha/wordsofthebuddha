...
"Bhikkhus, if while a bhikkhu is walking, a \{thought of sensuality} (sexual thought [kāmavitakka]), a \{thought of ill-will} (thought of resentment, anger, hatred [byāpādavitakka]) or a \{thought of harming} (idea of hurting, thought of curelty [vihiṁsāvitakka]) arises, and if that bhikkhu tolerates it, does not abandon it, dispel it, eliminate it, or brig it to an end, even while walking, such a bhikkhu is called 'unmotivated, \{without concern} (without regret, without remorse [anottāpī]), constantly slack, and \{lacking in endurance} (low in energy, weak in effort [hīnavīriya]).'
...
Whoever nurtures \{harmful thoughts} (thoughts which when acted upon lead to harm or injury or kammically unprofitable mental states [pāpaka + vitakka]),
