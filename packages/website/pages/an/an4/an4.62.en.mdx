...
by that, \{sees clearly} (understand with insight [vipassati]) with wisdom.

While seeing things clearly, the wise one,
knows \{both kinds of happiness} (one kind is the happiness of debtlessness, ownership, and using wealth; and the other kind is the ethical happiness of being debtless);
