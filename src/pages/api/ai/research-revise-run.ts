...
import { runResearchReviseJob } from "../../../utils/aiAskResearchReviseServer";
...
export const POST: APIRoute = async ({ request }) => {
	...
	const work = runResearchReviseJob({ uid, jobId, runToken }).catch((error) => {
		console.error("[ai/research/revise-run]", error);
	});
	try {
