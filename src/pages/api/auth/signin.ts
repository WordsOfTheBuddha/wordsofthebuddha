...
export const GET: APIRoute = async ({ request, cookies, redirect }) => {
    ...
    try {
        ...
        console.log(`[${opId}] User preferences: showPali=${showPali}, theme=${theme}, enablePaliLookup=${enablePaliLookup}, noteId=${noteId}`);
        ...
        if (!noteId) {
            ...
            console.log(`[${opId}] Default note created with ID: ${noteRef.id}`);
        ...
        try {
            ...
            console.error(`[${opId}] Error creating session cookie:`, createCookieError);
