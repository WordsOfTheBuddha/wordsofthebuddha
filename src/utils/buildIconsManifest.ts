...
const icons: IconEntry[] = [
	...
	},
	{
		...
		discourse: ["mn1", "mn113", "mn29", "mn30", "mn148", "mn138", "mn110"],
	...
	},
	{
		...
		discourse: ["mn1", "mn9", "mn25", "mn6", "mn111", "mn70", "mn77", "mn140", "mn43", "dn9"],
	...
	},
	{
		...
		discourse: ["mn1", "mn25", "mn6", "mn111", "mn77", "mn140", "mn43", "dn9"],
		tags: ["line-art"],
		themes: ["phenomena", "formless"],
	},
	{
		...
		discourse: ["mn1", "mn106", "mn25", "mn6", "mn111", "mn77", "mn140", "mn43", "dn9"],
		tags: ["line-art", "dashed"],
		themes: ["phenomena", "formless"],
	},
	{
		...
		discourse: ["mn1", "mn106", "mn25", "mn6", "mn111", "mn77", "mn140"],
		tags: ["line-art"],
		themes: ["phenomena", "formless"],
	},
	{
	...
	// MN 2
	{
		...
		discourse: ["mn2", "mn9", "mn18", "mn138", "sn46.2", "mn110", "dn9"],
		tags: ["burgundy", "line-art"],
	...
	},
	{
		...
		discourse: ["mn2", "mn18", "mn70", "mn138", "mn43", "sn46.2", "mn110", "dn9"],
		tags: ["teal", "line-art"],
	...
	},
	{
		...
		discourse: ["mn2", "mn39", "mn6"],
		tags: ["line-art"],
		themes: ["wholesome", "ethical conduct"]
	},
	{
		id: "endure",
		title: "Enduring",
	...
	},
	{
		...
		discourse: ["mn2", "mn95", "mn9", "an10.60", "mn43", "sn46.2", "dn9"],
		tags: ["line-art"],
		themes: ["five hindrances", "unwholesome", "harm"]
	},
	{
	...
	},
	{
		...
		discourse: ["mn39", "mn119", "mn25", "mn6", "mn43", "mn111", "mn77", "mn140"],
		tags: ["line-art", "gold"],
	...
	// Other discourses (sweep)
	{
		...
		discourse: ["an10.1", "mn9", "mn111", "mn18", "mn140", "mn138", "mn43"],
	...
	// MN 53 Sekha — training path (reuses MN2 eye-shield, MN119 divine eye, MN2 broken chain where noted)
	{
		...
		discourse: ["mn39", "mn53", "mn6", "mn111", "mn77", "dn9"],
	...
	},
	{
		...
		discourse: ["mn39", "mn53", "mn119", "mn6", "mn19"],
		tags: ["line-art", "sekha"],
		themes: ["insight", "liberation", "psychic power", "direct knowledge"],
	...
	},
	{
		...
		discourse: ["mn2", "mn53", "mn119", "mn138", "mn43"],
		tags: ["line-art", "sekha"],
		themes: ["liberation", "insight", "psychic power", "direct knowledge", "ending"],
	},
	// MN 148 Chachakka — nose and tongue internal-base icons (eye/ear/body/mind: seen, heard, body-observer, cognized)
	{
		id: "sense-nose",
	...
	},
	{
		...
		discourse: ["mn39", "mn43", "sn46.2", "dn9"],
		tags: ["line-art"],
		labels: ["five hindrances", "harm", "unwholesome"],
	},
	{
	...
	},
	{
		...
		discourse: ["mn39", "mn9", "mn110"],
		tags: ["line-art", "conduct"],
		labels: ["ethical conduct", "wholesome"],
	},
	{
		id: "simile-villages-traveler",
		title: "Simile: traveler among villages (past lives)",
		description: "Road, huts, and walking figure — pubbenivāsānussatiñāṇa",
		discourse: ["mn39", "mn77"],
		tags: ["line-art"],
		labels: ["direct knowledge", "insight", "psychic power", "simile"],
	},
	{
		id: "simile-two-houses",
		title: "Simile: seeing between two houses (divine eye)",
		description: "Observer between dwellings — cutūpapātañāṇa",
		discourse: ["mn39", "mn77"],
		tags: ["line-art"],
		labels: ["direct knowledge", "insight", "psychic power", "simile"],
	},
	{
		id: "simile-mountain-lake",
		title: "Simile: clear mountain lake (ending of taints)",
		description: "Still water, visible bottom, observer — āsavakkhayañāṇa",
		discourse: ["mn39", "mn77", "mn19"],
		tags: ["line-art"],
		labels: ["direct knowledge", "insight", "ending", "liberation", "psychic power", "simile"],
	},
	// ── MN 106 · Āneñjasappāya Sutta ────────────────────────────
	{
		...
		discourse: ["mn106", "mn9", "mn111", "mn138", "an10.60"],
		tags: ["line-art"],
	...
	},
	{
		...
		discourse: ["mn106", "mn140", "mn138", "an10.60", "dn9"],
		tags: ["line-art"],
	...
	// MN 25 Nivāpa — custom icon set
	{
		...
		discourse: ["mn25", "mn9", "mn19", "sn46.2", "dn9"],
		tags: ["line-art", "burgundy"],
		labels: ["harm", "five hindrances", "simile"],
	},
	{
		id: "herd-rushing-in",
		title: "Herd rushing in",
		description: "Vortex spiral — anupakhajja, herd consumed by infatuation",
		discourse: ["mn25", "mn43"],
		tags: ["line-art"],
		labels: ["harm", "five hindrances", "simile"],
	},
	{
		id: "herd-barren-tree",
		title: "Herd: barren tree",
		description: "Bare tree — extreme abstinence, strength failed",
		discourse: "mn25",
		tags: ["line-art"],
		labels: ["harm", "simile"],
	},
	{
		id: "herd-visible-lair",
		title: "Herd: visible lair",
		description: "Shelter glyph inside dashed net — āsayaṁ kappayiṁsu, found by stake-nets",
		discourse: "mn25",
		tags: ["line-art", "dashed"],
		labels: ["harm", "simile", "wrong view"],
	},
	{
		id: "herd-beyond-reach",
		title: "Herd: beyond reach",
		description: "Circle past dashed barrier with gold rays — yattha agati nevāpikassa",
		discourse: "mn25",
		tags: ["line-art"],
		labels: ["liberation", "safety", "simile"],
	},
	{
		id: "cessation-vessel",
		title: "Cessation of perception and feeling",
		description: "Hollow vessel with dashed lines — saññāvedayitanirodha, intact body with no inner activity",
		discourse: ["mn25", "mn111", "mn70", "mn77", "mn140", "mn138", "an10.60", "mn43", "dn9"],
		tags: ["line-art", "gold", "dashed"],
		labels: ["ending"],
	},
	// ── MN 6 · Ākaṅkheyya Sutta ────────────────────────────
	{
		...
		description: "Flying cross-legged figure with radiance — iddhi",
		discourse: ["mn6", "mn77", "dn9"],
		tags: ["line-art"],
		labels: ["psychic power", "direct knowledge"],
	},
	{
		id: "divine-ear",
		title: "Divine ear element",
		description: "Ear with radiating concentric sound waves — dibbasotadhātu",
		discourse: ["mn6", "mn77"],
		tags: ["line-art"],
		labels: ["psychic power", "direct knowledge"],
	},
	{
		id: "mind-reading",
		title: "Mind-reading",
		description: "Two head profiles with connecting mind-waves — cetopariyañāṇa",
		discourse: ["mn6", "mn77"],
		tags: ["line-art"],
		labels: ["psychic power", "direct knowledge", "insight"],
	},
	{
		id: "meditation-seat",
		title: "Meditation posture",
		description: "Steady seated figure — anirākatajjhāna",
		discourse: ["mn6", "mn111", "mn140"],
		tags: ["line-art", "gold"],
		labels: ["collectedness", "mindfulness"],
	},
	{
		id: "discernment-lens",
		title: "Discernment",
		description: "Lens with centered point — vipassanā",
		discourse: ["mn6", "mn9", "mn111", "mn77", "mn95", "mn140", "mn138", "mn110", "dn9"],
		tags: ["line-art", "gold"],
	...
	},
	{
		...
		description: "Two companion figures joined at the center — sabrahmacārī",
		discourse: ["mn6", "mn110"],
		tags: ["line-art"],
		labels: ["community", "friendship"],
	},
	{
		id: "donor-fruit-bowl",
		title: "Donor service fruitful",
		description: "Offering bowl with rising benefit marks — mahapphalā mahānisaṁsā",
		discourse: "mn6",
		tags: ["line-art"],
		labels: ["giving", "faith"],
	},
	{
		id: "relatives-heart",
		title: "Relatives' recollection",
		description: "Heart-form with gentle smile — pasannacittā anussarantānaṁ",
		discourse: ["mn6", "mn70"],
		tags: ["line-art"],
		labels: ["faith"],
	},
	{
		id: "conquer-discontent",
		title: "Overcoming discontent",
		description: "Balanced central staff with two opposing drops — aratiratisaho",
		discourse: ["mn6", "mn110"],
		tags: ["line-art"],
		labels: ["diligence", "non-harm"],
	},
	{
		id: "conquer-fear",
		title: "Overcoming fear and terror",
		description: "Steady figure beside a fading fear-wave — bhayabheravasaho",
		discourse: "mn6",
		tags: ["line-art"],
		labels: ["safety"],
	},
	{
		id: "rooted-faith",
		title: "Faith supported by reasons",
		description: "A sturdy central pillar on a base of deep-growing organic roots — ākāravatī saddhā dassanamūlikā",
		discourse: ["mn47", "mn95", "mn70"],
		tags: ["line-art", "gold"],
		labels: ["faith", "direct knowledge", "collectedness"],
	},
	{
		id: "untainted-lotus",
		title: "Untainted lotus",
		description: "Lotus blossom with untouched water droplets — anupalitta",
		discourse: ["mn47", "mn19"],
		tags: ["line-art"],
		labels: ["renunciation", "integrity", "purity"],
	},
	// MN 77 Mahāsakuludāyī — new motifs
	{
		id: "honey-pure",
	...
	},
	{
		...
		discourse: ["mn77", "mn95", "mn140", "mn43", "mn110", "dn9"],
		tags: ["line-art"],
	...
	// MN 19 Similes
	{
		id: "simile-active-cowherd",
		title: "Simile: unwholesome autumn cowherd",
		description: "Cowherd striking/holding cows with a stick — vigilance with unwholesome thoughts",
		discourse: "mn19",
		tags: ["line-art"],
		labels: ["unwholesome", "diligence", "simile"],
		valence: "-ve",
	},
	{
		id: "simile-relaxed-cowherd",
		title: "Simile: wholesome summer cowherd",
		description: "Cowherd resting under a tree, simply aware — mindfulness of wholesome thoughts",
		discourse: "mn19",
		tags: ["line-art"],
		labels: ["wholesome", "mindfulness", "simile"],
		valence: "+ve",
	},
	// MN 18 Madhupiṇḍika — new icon
	{
	...
	},
	{
		id: "honey-ball",
		title: "Honey ball",
		description: "Compact sphere with honey drip — madhupiṇḍika simile; the Dhamma is sweet wherever tasted",
		discourse: "mn18",
		tags: ["line-art", "gold", "simile"],
		labels: ["simile", "well-being"],
		valence: "+ve",
	},
	// MN 140 Dhātuvibhaṅga — new icon
	{
		id: "goldsmith-crucible",
		title: "Goldsmith's crucible",
		description: "Crucible over flame with molten-gold shimmer — suvaṇṇakāra simile; purified equanimity as refined gold, fit to be directed anywhere yet left unworked",
		discourse: "mn140",
		tags: ["line-art", "gold", "simile"],
		labels: ["elements", "simile", "formless"],
		valence: "+ve",
	},
	// MN 138 Uddesavibhaṅga — the anusāri mechanism
	{
		id: "consciousness-following",
		title: "Consciousness running after",
		description:
			"Orb pulled after a receding object by a taut tether — anusāri viññāṇaṁ, consciousness carried along by the features it relishes",
		discourse: ["mn138", "mn110"],
		tags: ["burgundy", "line-art"],
		labels: ["attachment", "consciousness", "harm"],
	},
	{
		id: "consciousness-unbound",
		title: "Consciousness not running after",
		description:
			"Steady orb with a slack, open tether as the object passes — na anusāri viññāṇaṁ, unscattered and not fixated",
		discourse: "mn138",
		tags: ["teal", "line-art"],
		labels: ["consciousness", "free from attachment", "imperturbable"],
	},
	{
		id: "three-realms-existence",
		title: "Three realms of existence",
		description:
			"Three stacked bands — solid sensual, solid form, dashed formless: kāmabhava · rūpabhava · arūpabhava",
		discourse: ["mn43"],
		tags: ["line-art"],
		labels: ["phenomena", "simile"],
	},
	// MN 43 Mahāvedalla — analysis of wisdom, consciousness, and the releases of mind
	{
		id: "oil-lamp-flame-radiance",
		title: "Oil lamp — flame and radiance",
		description:
			"Lamp bowl with a wick flame inside a halo of radiance — acci and ābhā, each discerned in dependence on the other",
		discourse: ["mn43", "mn70"],
		tags: ["gold", "line-art", "simile"],
		labels: ["dependent co-arising", "vitality", "phenomena"],
	},
	{
		id: "perception-colors",
		title: "Perception of colours",
		description:
			"Four filled dots — blue, yellow, red, white: nīlaka, pītaka, lohitaka, odāta, what saññā perceives",
		discourse: ["mn43"],
		tags: ["line-art", "aggregates"],
		labels: ["perception", "phenomena"],
	},
	{
		id: "four-immeasurables",
		title: "Boundless release of mind",
		description:
			"Four petals radiating from a still centre — appamāṇā cetovimutti, the four immeasurables",
		discourse: ["mn43"],
		tags: ["gold", "line-art"],
		labels: ["loving-kindness", "compassion", "liberation", "boundless"],
	},
	{
		id: "signless-stillness",
		title: "Signless release of mind",
		description:
			"Ring with its inner sign struck through — animittā cetovimutti, giving no attention to any sign",
		discourse: ["mn43", "dn9"],
		tags: ["line-art"],
		labels: ["liberation", "letting go", "insight"],
	},
	// DN 9 Poṭṭhapāda — unique similes (mind-made reed reuses mind-made-body; formless circle reuses emptiness-void)
	{
		id: "unknown-beauty",
		title: "Unknown beauty",
		description:
			"Seeker reaching toward a dashed unseen woman with a question mark — janapadakalyāṇī, longing for a beauty one does not know or see",
		discourse: "dn9",
		tags: ["line-art", "simile"],
		labels: ["simile", "wrong view"],
	},
	{
		id: "unseen-palace",
		title: "Unseen palace",
		description:
			"Dashed multi-storey palace with stairs approaching — nisseṇiṁ … pāsādassa, a staircase to a palace one does not know",
		discourse: "dn9",
		tags: ["line-art", "simile", "dashed"],
		labels: ["simile", "wrong view"],
	},
	{
		id: "known-palace",
		title: "Known palace",
		description:
			"Solid grand palace with gold stairs underneath — tasseva pāsādassa heṭṭhā, a staircase built under the palace one can see",
		discourse: "dn9",
		tags: ["line-art", "simile", "gold"],
		labels: ["simile", "path"],
	},
];
