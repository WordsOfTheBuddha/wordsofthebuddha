...
// eslint-disable
export type SearchDoc = { slug: string; title: string; description?: string; content: string; contentPali?: string; maxScore?: number; priority?: number; contentSearchable?: boolean };
