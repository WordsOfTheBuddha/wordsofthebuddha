...
“|Bhikkhus,::::| I do not see any other single quality that prevents unarisen |doubt::uncertainty, indecision, lack of conviction [vicikicchā]| from arising, or causes arisen doubt to be abandoned, as |radical attention::wise attention, root-level attention, attention to the structural source, contextual reflection; lit. attention from the source [yoniso + manasikāra]|. |Bhikkhus,::::| when one wisely attends, unarisen doubt does not arise, and arisen doubt is abandoned.”
