...
‘The venerable Cunda the smith has accumulated |kamma::action, deed, doing, volitional act [kamma]| that leads to long life. The venerable Cunda the smith has accumulated kamma that leads to |beauty::good looks [vaṇṇa]|. The venerable Cunda the smith has accumulated kamma that leads to happiness. The venerable Cunda the smith has accumulated kamma that leads to |fame::glory, prestige [yasa]|. The venerable Cunda the smith has accumulated kamma that leads to heaven. The venerable Cunda the smith has accumulated kamma that leads to rulership.’ Ānanda, any remorse in Cunda the smith should be dispelled in this way.
