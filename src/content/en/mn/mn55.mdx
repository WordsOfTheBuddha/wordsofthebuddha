...
"Jīvaka, whatever |passion::intense desire, strong emotion, infatuation, obsession, lust [rāga]|, |aversion::ill will, hate, hatred, fault, resentment [dosa]|, and |illusion::delusion, hallucination, misapprehension, distorted view; that which fuels further confusion and doubt [moha]| that would lead to cruelty—such passion, aversion, and illusion has been abandoned by the Tathāgata, cut off at the root, made like a palm stump, and done away with so it is no longer subject to future arising. If you speak with this in mind, Jīvaka, I allow you to say so."
