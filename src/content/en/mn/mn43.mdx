...
“Friend, there are two conditions for the arising of right view: the |words::voice, utterance [ghosa]| of another and |radical attention::root-level attention, attention to the structural source, contextual reflection, matrix-based awareness; lit. attention from the source [yoniso + manasikāra]|. These, friend, are the two conditions for the arising of right view.”
