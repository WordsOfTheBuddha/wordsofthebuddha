...
Ānanda, if one is asked: ‘Does contact have a specific condition?’ one should say: ‘Yes, it does.’ If one is asked: ‘With what as a condition does contact come to be?’ one should say: ‘With |name and form::feeling, perception, intention, contact and attention — the elementary acts of recognition and designation — are "name". Materiality, material existence, experience of the material world, i.e. encompassing both one’s body and external objects, whether near or far, gross or subtle, deficient or refined; first of the five aggregates [nāmarūpa]| as a condition, contact comes to be.’
