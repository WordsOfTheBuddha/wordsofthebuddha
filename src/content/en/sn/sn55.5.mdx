...
“|Association with persons of integrity::association with true persons [sappurisasaṁseva]|, venerable sir, is a factor of stream-entry. Hearing the true |Dhamma::teachings of the Buddha that point to the nature of reality, the ultimate truth [dhamma]| is a factor of stream-entry. |Radical attention::wise attention, root-level attention, attention to the structural source, contextual reflection; lit. attention from the source [yoniso + manasikāra]| is a factor of stream-entry. Practice in accordance with the Dhamma is a factor of stream-entry.”
