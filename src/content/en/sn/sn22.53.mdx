...
Consciousness, bhikkhus, while persisting, might persist attached to |intentional constructions::intentions, volitions, choices; mental and bodily volitional activities; thought formations and constructed experiences (including proliferative tendencies); kamma-producing processes [saṅkhāra]|, based on [the field of] intentional constructions, with intentional constructions as a support—and there, with a sprinkling of delight—it comes to growth, increase, and full maturation.
