...
description: >-
  Venerable Mahākoṭṭhita asks Venerable Sāriputta if the eye is the fetter of
  forms or if forms are the fetter of the eye. Venerable Sāriputta explains that
  it is the desire and attachment that arises in dependence on both that is the
  fetter.
