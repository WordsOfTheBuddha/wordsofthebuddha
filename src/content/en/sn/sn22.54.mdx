...
Consciousness, bhikkhus, while |persisting::remaining [tiṭṭhamāna]|, might persist |attached to form::attracted to form, engaged with materiality; lit. approaching form [rūpupaya]|, based on [the field of] form, with |form::a visible object such as a beautiful sight, a face, an expression, art, ornament, possession, status symbol, admired appearance, or enticing scenery—anything seen that can produce desire, attachment, or self-view [rūpa]| as a support—and there, with a sprinkling of |delight::pleasure, enjoyment, relish [nandi]|—it comes to growth, increase, and maturity.
