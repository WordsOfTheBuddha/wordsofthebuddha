...
If the |wind element::whatever internal or external that is airy, gaseous, moving, vibrating, wind-like, which can be considered as belonging to oneself and can be clung to [vāyodhātu]| were exclusively unpleasant, beset by suffering, filled with suffering, and if it were also not associated with ease, beings would not be infatuated with the wind element. But because, bhikkhus, the wind element is not exclusively unpleasant, not beset by suffering, not filled with suffering, and is also associated with ease, beings are infatuated with the wind element.
