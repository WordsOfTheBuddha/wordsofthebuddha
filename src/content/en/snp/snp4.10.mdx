...
Neither |self::soul, essence, taking up [atta]| or even |non-self::no self, soullessness, rejection [niratta]|,
is found in that person.

Whether he is called this or that,
by |ordinary persons::a common person, a worldling [puthujjana]|, or by ascetics and brahmins;
