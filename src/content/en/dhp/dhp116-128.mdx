...
for the accumulation of good brings |happiness::contentment, ease, pleasant abiding [sukha]|.
...
and one wishing to live avoids poison;
so too, should one avoid harmful actions.

#### 124

If there is no wound on the hand,
one may carry poison in the hand;
poison does not affect one without a wound,
and there is no consequence for one who does no harm.
...
and the |taintless::undefiled, free from effluents, free from mental defilements [anāsava]| attain final liberation.

#### 127

Neither in the sky, nor in the middle of the sea,
nor by entering a mountain cave;
no place exists in the world where,
staying, one might escape from their |evil deeds::unwholesome actions, harmful actions, misconduct [pāpakammā]|.
...
nor by entering a mountain cave;
no place exists in the world where,
staying, death would not overcome one.
