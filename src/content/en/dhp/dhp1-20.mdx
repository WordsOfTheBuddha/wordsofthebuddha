...
Only by |non-hatred::without animosity, with kindness, with goodwill [avera]| is hostility settled,
...
Abandoning passion, |aversion::ill will, hatred, hostility, mental attitude of rejection, fault-finding, resentful disapproval [dosa]|, and |illusion::delusion, hallucination, misapprehension, distorted view; that which fuels further confusion and doubt [moha]|,
