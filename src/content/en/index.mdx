...
✨ **Interactive Reader** — Study the Buddha's well-preserved words with a clear English translation. Examine key terms such as \|greed::lust, wanting, desire [lobha]|, \|aversion::ill-will, hate, hatred, fault, resentment [dosa]|, and \|illusion::delusion, hallucination, misperception, distorted view; that which fuels not knowing of things as they have come to be [moha]| to cultivate reflection and gradually deepen your understanding.

📝 **Personal Study Space** — Save discourses, highlight text, and take notes to build your personal collection of insights.

🌐 **Join our open work** — The discourses are actively being translated. [Request a discourse or share feedback](https://github.com/WordsOfTheBuddha/wordsofthebuddha/discussions)
