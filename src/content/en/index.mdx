...
<div class="mb-8">
💬 **Contextual Tooltips** — Deepen your understanding with on-click explanations that provide Pāli word definitions and nuanced insights into key translated terms. Try on this excerpt from from [AN 3.66 - Sāḷha sutta](/an3.66):
...
<div class="mb-8">
🫂 Embrace your **independent learning journey** — Take notes, <mark class="highlight-yellow">highlight key passages</mark>, and bookmark discourses to <mark class="highlight-green">curate your personal collection of insights.</mark>
</div>
</article>
...
- [x] Provide context with tooltips for key terms that may benefit from a broader understanding, e.g. \|greed::lust, wanting, desire [lobha]|, \|aversion::ill-will, hate, hatred, fault, resentment [dosa]|, and \|illusion::delusion, hallucination, misperception, distorted view; that which fuels not knowing of things as they have come to be [moha]|.
